...
if (isset($_POST['excluir'])) {
    $id = $_POST['id'];
    $sql = "delete from metodos_de_pagamento where id={$id}";
    try {
...
$sql = "select * from metodos_de_pagamento";
...
$nome_pagina = "Métodos de Recebimento Cadastrados ";
    ...
    ?>
        <tr>
            ...
            <td class="d-flex d-print-none">
                <form action="Listagem_Alterar/metodo_alterar.php" method="post">
                ...
                <form action="Metodos_de_pagamentos_Cadastrados.php" method="post" onsubmit="return confirm('Quer mesmo excluir esse registro?')">
