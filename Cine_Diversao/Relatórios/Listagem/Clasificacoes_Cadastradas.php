...
if (isset($_POST['excluir'])) {
    $id = $_POST['id'];
    $sql = "delete from classificacao where id={$id}";
    try {
...
$nome_pagina = "Classificações Cadastradas ";
?>
    ...
    ?>
        ...
        <tr>
            ...
            <td class="d-flex d-print-none">
                <form action="Listagem_Alterar/class_alter.php" method="post">
                ...
                <form action="Clasificacoes_Cadastradas.php" method="post" onsubmit="return confirm('Quer mesmo excluir esse registro?')">
