...
$nome_pagina = "Estados Cadastradas ";
    ...
    ?>
        <tr>
            ...
            <td class="d-flex d-print-none">
                <form action="Listagem_Alterar/estado_alterar.php" method="post">
                ...
                <form action="Estados_Candastrados.php" method="post" onsubmit="return confirm('Quer mesmo excluir esse registro?')">
