...
$nome_pagina = "Gêneros Cadastrados ";
    ...
    ?>
        <tr>
            ...
            <td class="d-flex d-print-none">
                <form action="Listagem_Alterar/genero_alterar.php" method="post">
                ...
                <form action="Generos_Cadastrados.php" method="post" onsubmit="return confirm('Quer mesmo excluir esse registro?')">
